...
if(preg_match('#' . basename(__FILE__) . '#', $_SERVER['PHP_SELF'])) { die('You are not allowed to call this page directly.'); }
	...
	<h2><?php _e('Copyright notes / Credits', 'nggallery') ;?></h2>
		<h4><?php _e("NextGEN DEV Team", 'nggallery'); ?></h4>
		...
		<h4><?php _e("Contributors / Tribute to", 'nggallery'); ?></h4>
		...
		<h4><?php _e("How to support ?", 'nggallery'); ?></h4>
		...
		<h4 id="donators"><?php _e("Thanks!", 'nggallery'); ?></h4>
