...
if(preg_match('#' . basename(__FILE__) . '#', $_SERVER['PHP_SELF'])) { die('You are not allowed to call this page directly.'); }
	...
	<h2><?php _e('Copyright notes / Credits', 'nggallery') ;?></h2>
		...
		<p><?php _e('This plugin is written as last study on WordPress. I take the chance to learn PHP, WordPress and programming technics with this plugin.
		...
		<p><?php _e('So, I would like to thanks the follow peoples for their pioneer work (without this work it\'s impossible to create so fast such a plugin)', 'nggallery') ;?></p>		
		<ul>
		...
		<p><?php _e('There exist several ways to contribute, help or support me in this work. No of them are mandatory.', 'nggallery') ;?></p>
		<ul>
			<li><strong><?php _e('Send me bugfixes / code changes', 'nggallery') ;?></strong><br /><?php _e('The most movtiated support for this plugin are your ideas and brain work', 'nggallery') ;?></li>
			<li><strong><?php _e('Translate my plugin', 'nggallery') ;?></strong><br /><?php _e('To help people to work with this plugin, I would like have it in all avaivable languages', 'nggallery') ;?></li>
			<li><strong><?php _e('Donate my work via paypal', 'nggallery') ;?></strong><br />
				...
				</form><?php _e('No doubt a very usefull and easy motivation :-) I send you a email , when I can buy my first Audi S3 with this money...', 'nggallery') ;?>
			</li>
		...
		<p><?php _e('I would like to thanks this peoples which support me in my work :', 'nggallery') ;?></p>
