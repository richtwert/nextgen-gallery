jQuery(function($){
    ...
    $.fn.NextGen_AttachToPost.display_edit_image_form = function(image_id)
    {
        ...
        $('#done_editing').live('click', function(){
            ...
            obj.action = '_validate_image';
            obj.image_id = gallery_image_id;
            ...
            $.post(obj.ajax_url, obj, function(data, status, xhr){
                ...
                if (data.success) {
                    ...
                    $('#image_list .image_form[rel="'+image_id+'"]').replaceWith(new_form.addClass('hidden'));
                }
    ...
    **/
    ...
    $.fn.NextGen_AttachToPost.save_button_clicked = function(e)
    {
        ...
        // Temporarily unattach the image form
        var image_forms = $('#image_list .image_form').detach();
        
        // Serialize the form
        var data = $('#attach_gallery').serializeObject();
        
        // Add the image forms back
        $('#image_list').append(image_forms);
