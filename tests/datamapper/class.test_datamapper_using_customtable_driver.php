...
class C_Test_DataMapper_Using_CustomTable_Driver extends C_Test_CustomTable_DataMapper_Base
{
	...
	{
		parent::__construct("Test Case for C_DataMapper using CustomTable Driver");
	}
	...
	function setUp()
	{
		...
		update_option(PHOTOCRATI_GALLERY_OPTION_PREFIX.'datamapper_driver', 'custom_table_datamapper');
