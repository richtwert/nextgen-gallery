 ...
 * @since 1.0.0
 */
class nggAdminPanel extends C_Component
{
	...
	{
		return $this->_get_registry()->get_utility('I_Photocrati_Options');
	}
    ...
    function admin_bar_menu() {
        ...
        if ( current_user_can(PHOTOCRATI_GALLERY_MANAGE_TAGS_CAP) )
