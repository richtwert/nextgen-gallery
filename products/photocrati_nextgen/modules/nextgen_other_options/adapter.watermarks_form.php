...
class A_Watermarks_Form extends Mixin
{
	...
	{
		return $this->object->render_partial('nextgen_other_options#watermark_image_fields', array(
	...
	function _render_watermark_text_fields()
	{
		...
		return $this->object->render_partial('nextgen_other_options#watermark_text_fields', array(
