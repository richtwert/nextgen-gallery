...
class M_NextGen_Data extends C_Base_Module
{
    ...
    function _register_adapters()
    {
        ...
        $this->get_registry()->add_adapter('I_Image',     'A_Parse_Image_Metadata', 'imported_image');
        $this->get_registry()->add_adapter('I_Image',     'A_Auto_Rotate_Image', 'imported_image');
        $this->get_registry()->add_adapter('I_Image',     'A_Auto_Resize_Image', 'imported_image');
